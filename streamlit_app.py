...
def load_movie_data():
    try:
        df = pd.read_csv(r"C:\Users\coren\Documents\wild_code_school\projets\projet_2_cinema\projet_final\df_recherche_films_avec_affiches.csv")
        return df
...
st.image(r"C:\Users\coren\Documents\wild_code_school\projets\projet_2_cinema\projet_final\image_accueil_site.jpg", use_container_width=True)
