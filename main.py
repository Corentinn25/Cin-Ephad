...
try:
    df_recherche_film = pd.read_csv(
        r"C:\Users\coren\Documents\wild_code_school\projets\projet_2_cinema\projet_final\df_recherche_films_avec_affiches.csv"
    )
    df_entrainement = pd.read_csv(
        r"C:\Users\coren\Documents\wild_code_school\projets\projet_2_cinema\projet_final\df_entrainement.csv"
    )
